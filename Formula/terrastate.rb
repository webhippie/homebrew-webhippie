...
class Terrastate < Formula
  ...
  devel do
    url "https://dl.webhippie.de/terrastate/master/terrastate-0.0.0-master-darwin-10.6-amd64"
    sha256 open("https://dl.webhippie.de/terrastate/master/terrastate-0.0.0-master-darwin-10.6-amd64.sha256").read.split(" ").first
    version "master"
  end
