...
#   #   sha256 open("https://dl.webhippie.de/misc/oauth2-proxy/0.1.0/oauth2-proxy-0.1.0-darwin-10.6-amd64.sha256").read.split(" ").first
#   #   version "0.1.0"
#   # end

#   devel do
#     url "https://dl.webhippie.de/misc/oauth2-proxy/master/oauth2-proxy-master-darwin-10.6-amd64"
#     sha256 open("https://dl.webhippie.de/misc/oauth2-proxy/master/oauth2-proxy-master-darwin-10.6-amd64.sha256").read.split(" ").first
#     version "master"
#   end
