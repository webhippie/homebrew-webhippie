...
class LdapProxy < Formula
  ...
  devel do
    url "https://dl.webhippie.de/ldap-proxy/master/ldap-proxy-0.0.0-darwin-10.6-amd64"
    sha256 open("https://dl.webhippie.de/ldap-proxy/master/ldap-proxy-0.0.0-darwin-10.6-amd64.sha256").read.split(" ").first
    version "master"
  end
