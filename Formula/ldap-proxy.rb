...
class LdapProxy < Formula
  ...
  # stable do
  #   url "https://dl.webhippie.de/ldap-proxy/0.1.0/ldap-proxy-0.1.0-darwin-10.6-amd64"
  #   sha256 open("https://dl.webhippie.de/ldap-proxy/0.1.0/ldap-proxy-0.1.0-darwin-10.6-amd64.sha256").read.split(" ").first
  #   version "0.1.0"
  # end

  devel do
    url "https://dl.webhippie.de/ldap-proxy/master/ldap-proxy-0.0.0-master-darwin-10.6-amd64"
    sha256 open("https://dl.webhippie.de/ldap-proxy/master/ldap-proxy-0.0.0-master-darwin-10.6-amd64.sha256").read.split(" ").first
    version "master"
  end
